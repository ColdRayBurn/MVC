...
?>
    <section class="hero-section">
        <div class="hero-items owl-carousel">
            <div class="single-hero-item set-bg" data-setbg="<?= SITE_TEMPLATE_PATH ?>/img/hero-slider/hero-1.jpg">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="hero-text">
            ...
            <div class="single-hero-item set-bg" data-setbg="<?= SITE_TEMPLATE_PATH ?>/img/hero-slider/hero-2.jpg">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="hero-text">
            ...
            <div class="single-hero-item set-bg" data-setbg="<?= SITE_TEMPLATE_PATH ?>/img/hero-slider/hero-3.jpg">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="hero-text">
    ...
    <section class="feature-section">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-4">
                    <div class="feature-item set-bg" data-setbg="<?= SITE_TEMPLATE_PATH ?>/img/feature/feature-1.jpg">
                        <h3>GROUP CLASSES</h3>
                ...
                <div class="col-md-4">
                    <div class="feature-item set-bg" data-setbg="<?= SITE_TEMPLATE_PATH ?>/img/feature/feature-2.jpg">
                ...
                <div class="col-md-4">
                    <div class="feature-item set-bg" data-setbg="<?= SITE_TEMPLATE_PATH ?>/img/feature/feature-3.jpg">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="video-text">
                        ...
                        <a href="https://www.youtube.com/watch?v=ocRN6Hz3LrI" class="play-btn video-popup">
            ...
            <div class="row blog-gird">
                ...
                <div class="col-lg-4 col-md-6 grid-item">
                    <div class="blog-item large-item set-bg" data-setbg="<?= SITE_TEMPLATE_PATH ?>/img/blog/blog-4.jpg">
                        ...
                        <div class="play-btn">
                            <a href="https://www.youtube.com/watch?v=ocRN6Hz3LrI" class="play-in-btn video-popup">
                                <i class="fa fa-play"></i>
                            </a>
                        </div>
                    </div>
